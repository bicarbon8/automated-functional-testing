...
import { AbstractBrowserGridSessionGeneratorPlugin, IBrowserGridSessionPluginOptions } from "../../../src";

describe('AbstractBrowserGridSessionGeneratorPlugin', () => {
    beforeEach(() => {
...
class FakeGridSession extends AbstractBrowserGridSessionGeneratorPlugin {
