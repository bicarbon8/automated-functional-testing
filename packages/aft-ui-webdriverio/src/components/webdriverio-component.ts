...
export class WebdriverIoComponent extends UiComponent {
    ...
    override get parent(): Func<void, Promise<WebdriverIO.Element | WebdriverIO.Browser>> { // eslint-disable-line no-undef
        return this._parent as Func<void, Promise<WebdriverIO.Element | WebdriverIO.Browser>>; // eslint-disable-line no-undef
    }
