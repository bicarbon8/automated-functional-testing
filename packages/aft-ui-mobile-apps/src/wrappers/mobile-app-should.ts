...
/**
 * function creates a new {MobileAppTestWrapper} that can be used like:
 * ```
 * await mobileAppShould({
 *   expect: async (tw) => {
 ...
 * ```
 * @param options a {MobileAppTestWrapperOptions} object containing the expectation and other options
 */
